...
export default class PetrolScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isloading: true,
    ...
    componentWillMount() {
        fetch('https://api.snowyguide.com/dev/pages/petrol', {
            method: 'GET',
            headers: {
    ...
    navigateToDetail(rowdata) {
        if (rowdata.url) {
            ...
            this.props.navigation.navigate("PetrolDetail", {petrol:rowdata});
            return;
        }
    }
    render() {
